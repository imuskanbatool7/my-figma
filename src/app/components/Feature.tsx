...
const Feature = () => {
  return (
    ...
    <section className='bg-white hover:border-2 hover:border-purple-600 p-6 sm:p-10 md:p-11 lg:p-12  w-full min-h-[355px] ml-3 mr-3 '>
      {/* subtittle */}
     <h2 className='text-center hover:border-2 hover:border-purple-600  text-lg md:text-xl lg:text-2xl mb-8 font-Clash-Display text-gray-400 '>Next day as standard</h2>
