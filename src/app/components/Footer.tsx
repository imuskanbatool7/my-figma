 ...
 const Footer = () => {
   return (
     <div className='px-4 py-8'>
       <section className=' bg-[#2A254B] flex justify-between hover:border-2 hover:border-purple-600 p-8 sm:p-10 md:p-11 lg:p-12  w-full min-h-[355px] ml-3 mr-3 ' >
        ...
        <div className='border-b-2 border-purple-700  mt-20 '></div>
