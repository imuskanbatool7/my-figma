...
const Signup = () => {
  return (
    <div className=' max-w  justify-between  mr-10 px-2 py-2 ' >
    <section  className='flex-col sm:flex md:flex lg:flexbg-white  hover:border-2 hover:border-purple-600 p-10 max-w-[1440px] h-[481px] mx-auto flex justify-between items-center'>
